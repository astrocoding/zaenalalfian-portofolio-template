...
export const ProfileForm: React.FC<ProfileFormProps> = ({
  ...
  const [aboutFormData, setAboutFormData] = React.useState({
    ...
    subtitle:
      initialAbout?.subtitle || "Bridging Design Vision & Technical Execution",
    excerpt:
  ...
  const [contactFormData, setContactFormData] = React.useState({
    ...
    linkedin:
      initialContact?.linkedin || "https://www.linkedin.com/in/zaenal-alfian/",
    instagram:
      initialContact?.instagram || "https://www.instagram.com/zenovasi/",
    facebook:
      initialContact?.facebook ||
  ...
  const handleSubmit = async (e?: React.FormEvent | React.MouseEvent) => {
    ...
    if (res.success) {
      setSuccess(
        "Profile, About section, & Contact details successfully updated! / プロフィール情報を更新しました。",
      );
      ...
      <div className="pt-[77px] lg:pt-[87px] px-4 sm:px-6 lg:px-6 space-y-6 w-full">
        ...
        <div className="bg-surface border border-border-warm rounded-xl p-5 sm:p-6 shadow-card space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onChange={(e) =>
                  setUserFormData({ ...userFormData, activity: e.target.value })
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onChange={(e) =>
                  setUserFormData({ ...userFormData, location: e.target.value })
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              <label className="text-xs font-mono font-medium text-ink">
                Personal Quote / モットー・座右の銘
              </label>
              <input
                type="text"
                value={userFormData.quotes}
                onChange={(e) =>
                  setUserFormData({ ...userFormData, quotes: e.target.value })
                }
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-mono font-medium text-ink">
                Resume Document Link / 履歴書・CV リンク
              </label>
              <input
                type="text"
                value={userFormData.resume}
                onChange={(e) =>
                  setUserFormData({ ...userFormData, resume: e.target.value })
                }
        ...
        <div className="bg-surface border border-border-warm rounded-xl p-5 sm:p-6 shadow-card space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              onChange={(e) =>
                setAboutFormData({ ...aboutFormData, excerpt: e.target.value })
              }
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-mono font-medium text-ink">
              Full Description Story / 詳細説明（複数パラグラフ対応） *
            </label>
            <textarea
              required
              rows={7}
            ...
            <span className="text-[10px] font-mono text-ink-muted block mt-1">
              Tip: Press Enter twice to create paragraph line breaks on the
              public /about page.
            </span>
          </div>
        </div>
