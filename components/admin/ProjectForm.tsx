      ...
      <div className="pt-[87px] px-4 sm:px-6 lg:px-6 pb-4 sm:pb-6 lg:pb-6">
        <div className="space-y-5 bg-surface border border-border-warm rounded-xl p-5 sm:p-6 shadow-card">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4">
            <div className="lg:col-span-4 bg-watermark-surface/40 p-4 sm:p-5 rounded-xl border border-[#c8c5c2] flex flex-col justify-between">
              <ImageUploader
            ...
            <div className="lg:col-span-8 bg-watermark-surface/40 p-4 sm:p-5 rounded-xl border border-[#c8c5c2] flex flex-col justify-between">
              <ImageUploader
