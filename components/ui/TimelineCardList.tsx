...
export const TimelineCardList: React.FC<TimelineCardListProps> = ({
  ...
  return (
    <div className={`relative pl-6 sm:pl-8 border-l-2 border-border-warm space-y-12 my-8 ${className}`}>
      {items.map((item, idx) => {
        ...
        return (
          <div key={(item.id || item.title) + idx} className="relative group">
            ...
            <div className="absolute -left-[31px] sm:-left-[39px] top-1.5 w-4 h-4 rounded-full bg-surface border-2 border-primary group-hover:bg-primary transition-colors flex items-center justify-center z-10">
