        ...
        <Container size="default" className="space-y-10">
          ...
          <div className="space-y-6 pt-6 border-t border-border-warm">
            ...
            {cards.length === 0 ? (
              ...
              <StaggerContainer staggerDelay={60} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {cards.map(
                  (
                    pillar: {
                      id?: string;
          ...
          <div className="space-y-6 pt-10 border-t border-border-warm">
            ...
            {skillCategories.length === 0 ? (
              ...
              <StaggerContainer staggerDelay={60} className="grid grid-cols-1 md:grid-cols-2 gap-6">
